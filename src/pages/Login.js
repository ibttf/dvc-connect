  ...
  return(
    <div>
        ...
        <div className="h-12 pointer-events-none mt-2 text-md  leading-6">
            ...
            <h3 onClick={()=>navigate("/admin-login")}className="text-center cursor-pointer text-sm text-gray-400 hover:text-gray-700 mt-3">
            Admin?
            </h3>
...
<form className="space-y-6 ">
            ...
            {/* Email Input */}
            <div>
                <div className={`h-12 pointer-events-none mt-2 text-md leading-6 ${email.length > 0 && emailError ? "border-red-500" : "border-gray-500"}`}>
                    <input 
                        className={`peer pointer-events-auto block w-full py-1.5 font-normal text-gray-900 border-b-2 border-0 ${email.length > 0 ? (emailError ? "border-red-500" : "border-gray-900") : "border-gray-500"} focus:border-gray-900 focus:ring-0 placeholder:text-gray-400 sm:text-sm sm:leading-6`}
                        onChange={(e) => setEmail(e.target.value)} 
                        id="email" 
                        name="email" 
                        type="email" 
                        ...
                        required 
                    /> 
                    <label htmlFor="email" className={`block text-gray-700 relative ${email.length > 0 ? "-top-14 text-xs" : "peer-focus:-top-14 peer-focus:text-xs -top-7"} duration-300`}>Email address</label> 
                </div>
            ...
            <div>
                <div className={`h-12 pointer-events-none mt-2 text-md leading-6 ${passwordConfirmation.length > 0 && passwordConfirmError ? "border-red-500" : "border-gray-500"}`}>
                    <input 
                        className={`peer pointer-events-auto block w-full py-1.5 font-normal text-gray-900 border-b-2 border-0 ${passwordConfirmation.length > 0 ? (passwordConfirmError ? "border-red-500" : "border-gray-900") : "border-gray-500"} focus:border-gray-900 focus:ring-0 placeholder:text-gray-400 sm:text-sm sm:leading-6`}
