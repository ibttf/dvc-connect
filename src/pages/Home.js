    ...
    style={{
      ...
      <div className="md:w-108 w-11/12 mx-auto md:py-8 py-4">
        ...
        <Link 
          ...
          className="md:w-1/12 mx-auto inline-flex items-center px-4 py-2 bg-gray-800 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-200 active:bg-gray-800 transition duration-300"
        >
