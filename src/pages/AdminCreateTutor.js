        ...
        <div className="mt-5 px-8 w-full mx-auto">
            <form className="space-y-6">
                ...
                <div className="grid md:grid-cols-4 grid-cols-6 grid-rows-1 items-center gap-4 w-full">
                    <h1 className="col-span-1 font-semibold text-gray-700 md:text-md text-xxs">They teach: </h1>
                ...
                <div className="grid md:grid-cols-4 grid-cols-6 grid-rows-1 items-center gap-4 w-full">
                    <h1 className="col-span-1 font-semibold text-gray-700 md:text-md text-xxs">They can speak: </h1>
                    <div className="flex flex-wrap md:col-span-3 col-span-5 items-center">
                ...
                <div className="grid md:grid-cols-4 grid-cols-6 items-center gap-4 w-full">
                    <h1 className="col-span-1 font-semibold text-gray-700 md:text-md text-xxs">Hours Worked: </h1>
