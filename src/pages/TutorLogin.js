      ...
      <div className="flex min-h-full flex-col justify-center px-6 py-6 lg:px-8 bg-white md:w-6/12 w-11/12 mx-auto my-12 md:mb-48 rounded-xl shadow-xl">
        ...
        {showLogin ? (
          <div className="mt-5 p-8 rounded-xl md:w-8/12 w-full md:px-0 px-2 mx-auto">
            ...
            <h3
              onClick={() => props.setAdmin(!props.admin)}
          ...
          <div className="">
              ...
              <div className="mt-5  p-8 rounded-xl md:w-6/12 w-full md:px-0 px-2 mx-auto">
                <form className="space-y-6 ">
                  ...
                  <div>
                    ...
                    {password.length > 0 && passwordError && (
                      <ul className={` mt-2`}>
                        ...
                        >
                          {/[A-Z]/.test(password) ? "✓" : "✗"} Contains at least
                  ...
                  <div>
                    <div
                      className={`h-12 pointer-events-none mt-2 text-md leading-6 ${
                        passwordConfirmation.length > 0 && passwordConfirmError
                          ? "border-red-500"
                          : "border-gray-500"
                      }`}
                    >
                ...
                <h3
                  onClick={() => props.setAdmin(!props.admin)}
                  className="text-center cursor-pointer text-sm text-gray-400 hover:text-gray-900"
                >
                  Admin?
                </h3>
              </div>
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-4 grid-cols-6 items-center gap-4 w-full">
                    ...
                    <div className="relative md:col-span-3 col-span-5">
                      ...
                      >
                        <option className="" value="Math Lab">
                          Math Lab
                        </option>
                        <option className="" value="English Lab">
                          English Lab
                        </option>
                        <option className="" value="Reading Lab">
                          Reading Lab
                        </option>
                        <option className="" value="Science Lab">
                          Science Lab
                        </option>
                        <option className="" value="Social Studies Lab">
                          Social Studies Lab
                        </option>
                      </select>
            ...
            {step === 3 && (
              <div className="mt-5 md:border-4 border-2 border-indigo-600 p-8 rounded-xl shadow-lg w-full mx-auto text-center">
                <form className="space-y-6">
                  <h2 className="md:text-xl text-md font-normal mb-4 underline">
                    Confirm Information
                  </h2>
                  ...
                  <p className="font-normal md:text-md text-xs">
                    Work Location:{" "}
                    <span className="font-bold">{workLocation}</span>
                  </p>
                  <p className="font-normal md:text-md text-xs">
                    Subjects Taught:{" "}
                    <span className="font-bold">
